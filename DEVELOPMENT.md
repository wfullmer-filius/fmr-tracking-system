...
```bash
git remote add encore encore://fmr-tracking-system-k27i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/fmr-tracking-system-k27i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/fmr-tracking-system-k27i/settings/integrations/github)
